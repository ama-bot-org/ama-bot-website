export default {
  ...
  'agreement.agreement.service': '《AiyinAI Service Agreement》',
  'agreement.agreement.and': 'and',
  'agreement.agreement.privacy': '《《AiyinAI Privacy Policy》',
  'agreement.service.welcome':
    'Welcome to use Aiyin AI service! Please read the following agreement carefully before using this service. Once you use this service, it will be deemed that you have agreed to all the contents of this agreement. If you have any questions, please contact us.',
  'agreement.service.h3_1': 'Service Description',
  'agreement.service.p_1':
    'Aiyin AI registration service is an online service that provides AI automatic Q&A function. Users can obtain information, ask questions, and automatically obtain answers through this service. This service is provided and maintained by Aiyin AI Team and may be continuously updated and improved.',
  ...
  'agreement.service.p_2_4':
    'If users violate the above regulations, Aiyin AI Team has the right to suspend or terminate their right to use this service at any time.',
  'agreement.service.h3_3': 'Disclaimer',
  'agreement.service.p_3_1':
    'This service may be affected by various factors, including but not limited to internet connection quality, software version, etc. Aiyin AI Team does not guarantee that this service can always run smoothly and is not responsible for any losses caused by the interruption, stoppage or inability to use this service.',
  'agreement.service.p_3_2':
    'When using this service, users should make sufficient discrimination and judgment on their own and should not rely on the information provided by this service to make decisions. Aiyin AI Team is not responsible for any losses caused by users relying on the information provided by this service.',
  ...
  'agreement.service.p_4_1':
    'Aiyin AI Team has the right to modify any content of this agreement and publicize it on this website. If you do not agree with the modified content of the agreement, you can choose to stop using this service. If you continue to use this service, it will be deemed that you have agreed to the modified content of the agreement.',
  'agreement.service.p_4_2': 'Thank you for choosing Aiyin AI registration service, wish you a happy use!',
  'agreement.privacy.welcome':
    'Welcome to use Aiyin AI. We value your privacy very much. This document will explain in detail how we collect, use and protect your personal information. Please read the following carefully.',
  ...
  'agreement.privacy.p_8': 'Thank you for choosing Aiyin AI, we wish you a pleasant use!',
}
