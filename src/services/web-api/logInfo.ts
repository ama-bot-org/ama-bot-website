...
import { GetLogInfoTableParamsType, LogInfoTableResponseType, CommentInfoParamsType } from './models/logInfo'
...
async function commentInfo(params: CommentInfoParamsType) {
  return request<ErrorResponse>('/api/app/log/commentInfo', {
    method: 'POST',
    data: params,
  })
}
